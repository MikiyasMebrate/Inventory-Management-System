<template>
    <form @submit.prevent="emitSubmit" class="p-4 md:p-5">
        <fwb-modal v-if="isShowSaleModal" @close="emitClose"
...
// const { isShowSaleModal, entityType, title } = defineProps(['isShowSaleModal', 'entityType', 'title'])

const emit = defineEmits(['close', 'submit']);

const props = defineProps({
    title: String,
    isShowSaleModal: Boolean,
    entityType: String,
});
